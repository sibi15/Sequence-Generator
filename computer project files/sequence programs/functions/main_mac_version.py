...
def send_text():
    ...
    if tr1=='n':
        ...
        time.sleep(1)
        text=sys.stdin.read()
        shell_w=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/shellwindow.txt','w')
        shell_w.write(text)
        shell_w.close()
        shell_r=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/shellwindow.txt','r')
        time.sleep(1)
...
def send_infotranscript():
    ...
    if tr3=='n':
        ...
        for i in range(1,n+1):
            ...
            file1=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/fibonaccinumbers.txt','r')
            r1=file1.readlines()
            for j in r1:
                message=j.strip()
                body='\r\n'.join(['To: %s' % receiver_id,
            ...
            file2=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/prime numbers.txt','r')
            r2=file2.readlines()
            for j in r2:
                message=j.strip()
                body='\r\n'.join(['To: %s' % receiver_id,
            ...
            file3=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/collatz sequence.txt','r')
            r3=file3.readlines()
            for j in r3:
                message=j.strip()
                body='\r\n'.join(['To: %s' % receiver_id,
            ...
            file4=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/pascal triangle numbers.txt','r')     
            r4=file4.readlines()
            for j in r4:
                message=j.strip()
                body='\r\n'.join(['To: %s' % receiver_id,
            ...
            file5=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/pentagonal numbers.txt','r')           
            r5=file5.readlines()
            for j in r5:
                message=j.strip()
                body='\r\n'.join(['To: %s' % receiver_id,
            ...
            file6=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/fermat numbers.txt','r')               
            r6=file6.readlines()
            for j in r6:
                message=j.strip()
                body='\r\n'.join(['To: %s' % receiver_id,
...
def send_direct():
    ...
    if tr4=='n':
        ...
        for i in range(1,n+1):
            ...
            message1=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/fibonaccinumbers.txt','r')
            ...
            message2=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/prime numbers.txt','r')
            ...
            message3=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/collatz sequence.txt','r')
            ...
            message5=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/pentagonal numbers.txt','r')
            ...
            message6=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/fermat numbers.txt','r')
...
def send_multilinestring():
    ...
    if tr5=='n':
        ...
        for i in range(1,n+1):
            ...
            m4=''''''
            message4=open('/Users/sibikarthik/Desktop/CS/python files/python projects/computer project files/pascal triangle numbers.txt','r')
            message4=message4.read()
            m4=m4+message4
            body='\r\n'.join(['To: %s' % receiver_id,
                    'From: %s' % sender_id,
